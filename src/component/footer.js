        ...
        return (
            <footer>
                <div className="container py-5">
                    <div className="row">
                        <div className="col-12 col-md"> LOGO <small className="d-block my-3 text-muted">© 2017-2018</small> </div>
                        ...
                        <div className="col-6 col-md">
                            ...
                            <ul className="list-unstyled text-small">
                                <li>
                                    <a className="text-muted" href="/">Business</a>
                                </li>
                                <li>
                                    <a className="text-muted" href="/">Education</a>
                                </li>
                                <li>
                                    <a className="text-muted" href="/">Government</a>
                                </li>
                                <li>
                                    <a className="text-muted" href="/">Gaming</a>
                                </li>
                            </ul>
                        </div>
                        <div className="col-6 col-md">
